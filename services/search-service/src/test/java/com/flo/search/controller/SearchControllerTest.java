...
class SearchControllerTest {
    ...
    private static final Product NIKE = new Product(1L, "Air Runner X1", "Nike", "Spor Ayakkabı", 2899.90, 42);
    private static final Product ADIDAS = new Product(2L, "UltraBoost Flow", "Adidas", "Spor Ayakkabı", 3199.00, 15);
    ...
    void search_returnsMatchingProducts_whenQueryMatchesName() throws Exception {
        ...
        mockMvc.perform(get("/search").param("q", "nike"))
    ...
    void search_returnsEmptyList_whenNoProductMatches() throws Exception {
        ...
        mockMvc.perform(get("/search").param("q", "zzz-yok"))
                .andExpect(status().isOk())
